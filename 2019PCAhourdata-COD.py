# !/usr/bin/python3
# @File: 2019PCAhourdata-COD.py
# --coding:utf-8--
# @Author:Blazer
# @Time: 2020年08月03日20时37分38秒
# 说明: 用PCA后的控制变量数据代替原控制变量数据回归出水水质
...
# 添加标题和坐标轴标签
plt.title('PCA-ANN hybrid model predict COD')
...
import datetime
plt.savefig('E:/pycharm project/小论文/结果图表/' + datetime.datetime.now().strftime("%Y-%m-%d-%H-%M-%S") + 'COD-scheme2.jpg')
plt.show()
